...
import com.seoulit.erp47.hrs.yeta.dao.HmDeptDAO;
import com.seoulit.erp47.hrs.yeta.dao.HmEmpDAO;
import com.seoulit.erp47.hrs.yeta.dao.HsPayDAO;
import com.seoulit.erp47.hrs.yeta.dao.HsRegularWorksSalaryDAO;
import com.seoulit.erp47.hrs.yeta.dao.HyDeductionDataDAO;
import com.seoulit.erp47.hrs.yeta.dao.HyDependentDAO;
import com.seoulit.erp47.hrs.yeta.dao.HyDependentDonationDAO;
import com.seoulit.erp47.hrs.yeta.dao.HyDependentEducationDAO;
import com.seoulit.erp47.hrs.yeta.dao.HyDependentInsuranceDAO;
import com.seoulit.erp47.hrs.yeta.dao.HyDependentMedicalDAO;
import com.seoulit.erp47.hrs.yeta.dao.HyDependentPaymentDAO;
import com.seoulit.erp47.hrs.yeta.dao.HyFormerCompanyDAO;
import com.seoulit.erp47.hrs.yeta.dao.HyYtaResultDAO;
...
public class YetaApplicationServiceImpl implements YetaApplicationService {
	...
	public void batchHmDeptProcess(List<HmDeptBean> hmDeptBeanList) {
		for (HmDeptBean hmDeptBean : hmDeptBeanList) {
			...
			case "inserted":
				hmDeptDAO.insertHmDept(hmDeptBean);
				break;
			case "updated":
				hmDeptDAO.updateHmDept(hmDeptBean);
				break;
			case "deleted":
				hmDeptDAO.deleteHmDept(hmDeptBean);
				break;
			}
		}
	}
	...
	public void batchHmEmpProcess(List<HmEmpBean> hmEmpBeanList) {
		for (HmEmpBean hmEmpBean : hmEmpBeanList) {
			...
			case "inserted":
				hmEmpDAO.insertHmEmp(hmEmpBean);
				break;
			case "updated":
				hmEmpDAO.updateHmEmp(hmEmpBean);
				break;
			case "deleted":
				hmEmpDAO.deleteHmEmp(hmEmpBean);
				break;
			}
		}
	}
	...
	public void batchHsPayProcess(List<HsPayBean> hsPayBeanList) {
		for (HsPayBean hsPayBean : hsPayBeanList) {
			...
			case "inserted":
				hsPayDAO.insertHsPay(hsPayBean);
				break;
			case "updated":
				hsPayDAO.updateHsPay(hsPayBean);
				break;
			case "deleted":
				hsPayDAO.deleteHsPay(hsPayBean);
				break;
			}
		}
	}
	...
	public void batchHsRegularWorksSalaryProcess(List<HsRegularWorksSalaryBean> hsRegularWorksSalaryBeanList) {
		for (HsRegularWorksSalaryBean hsRegularWorksSalaryBean : hsRegularWorksSalaryBeanList) {
			...
			case "inserted":
				hsRegularWorksSalaryDAO.insertHsRegularWorksSalary(hsRegularWorksSalaryBean);
				break;
			case "updated":
				hsRegularWorksSalaryDAO.updateHsRegularWorksSalary(hsRegularWorksSalaryBean);
				break;
			case "deleted":
				hsRegularWorksSalaryDAO.deleteHsRegularWorksSalary(hsRegularWorksSalaryBean);
				break;
			}
		}
	}
	...
	public void batchHyDeductionDataProcess(List<HyDeductionDataBean> hyDeductionDataBeanList) {
		for (HyDeductionDataBean hyDeductionDataBean : hyDeductionDataBeanList) {
			...
			case "inserted":
				hyDeductionDataDAO.insertHyDeductionData(hyDeductionDataBean);
				break;
			case "updated":
				hyDeductionDataDAO.updateHyDeductionData(hyDeductionDataBean);
				break;
			case "deleted":
				hyDeductionDataDAO.deleteHyDeductionData(hyDeductionDataBean);
				break;
			}
		}
	}
	...
	public void batchHyDependentProcess(List<HyDependentBean> hyDependentBeanList) {
		for (HyDependentBean hyDependentBean : hyDependentBeanList) {
			...
			case "inserted":
				hyDependentDAO.insertHyDependent(hyDependentBean);
				break;
			case "updated":
				hyDependentDAO.updateHyDependent(hyDependentBean);
				break;
			case "deleted":
				hyDependentDAO.deleteHyDependent(hyDependentBean);
				break;
			}
		}
	}
	...
	public void batchHyDependentDonationProcess(List<HyDependentDonationBean> hyDependentDonationBeanList) {
		for (HyDependentDonationBean hyDependentDonationBean : hyDependentDonationBeanList) {
			...
			case "inserted":
				hyDependentDonationDAO.insertHyDependentDonation(hyDependentDonationBean);
				break;
			case "updated":
				hyDependentDonationDAO.updateHyDependentDonation(hyDependentDonationBean);
				break;
			case "deleted":
				hyDependentDonationDAO.deleteHyDependentDonation(hyDependentDonationBean);
				break;
			}
		}
	}
	...
	public void batchHyDependentEducationProcess(List<HyDependentEducationBean> hyDependentEducationBeanList) {
		for (HyDependentEducationBean hyDependentEducationBean : hyDependentEducationBeanList) {
			...
			case "inserted":
				hyDependentEducationDAO.insertHyDependentEducation(hyDependentEducationBean);
				break;
			case "updated":
				hyDependentEducationDAO.updateHyDependentEducation(hyDependentEducationBean);
				break;
			case "deleted":
				hyDependentEducationDAO.deleteHyDependentEducation(hyDependentEducationBean);
				break;
			}
		}
	}
	...
	public void batchHyDependentInsuranceProcess(List<HyDependentInsuranceBean> hyDependentInsuranceBeanList) {
		for (HyDependentInsuranceBean hyDependentInsuranceBean : hyDependentInsuranceBeanList) {
			...
			case "inserted":
				hyDependentInsuranceDAO.insertHyDependentInsurance(hyDependentInsuranceBean);
				break;
			case "updated":
				hyDependentInsuranceDAO.updateHyDependentInsurance(hyDependentInsuranceBean);
				break;
			case "deleted":
				hyDependentInsuranceDAO.deleteHyDependentInsurance(hyDependentInsuranceBean);
				break;
			}
		}
	}
	...
	public void batchHyDependentMedicalProcess(List<HyDependentMedicalBean> hyDependentMedicalBeanList) {
		for (HyDependentMedicalBean hyDependentMedicalBean : hyDependentMedicalBeanList) {
			...
			case "inserted":
				hyDependentMedicalDAO.insertHyDependentMedical(hyDependentMedicalBean);
				break;
			case "updated":
				hyDependentMedicalDAO.updateHyDependentMedical(hyDependentMedicalBean);
				break;
			case "deleted":
				hyDependentMedicalDAO.deleteHyDependentMedical(hyDependentMedicalBean);
				break;
			}
		}
	}
	...
	public void batchHyDependentPaymentProcess(List<HyDependentPaymentBean> hyDependentPaymentBeanList) {
		for (HyDependentPaymentBean hyDependentPaymentBean : hyDependentPaymentBeanList) {
			...
			case "inserted":
				hyDependentPaymentDAO.insertHyDependentPayment(hyDependentPaymentBean);
				break;
			case "updated":
				hyDependentPaymentDAO.updateHyDependentPayment(hyDependentPaymentBean);
				break;
			case "deleted":
				hyDependentPaymentDAO.deleteHyDependentPayment(hyDependentPaymentBean);
				break;
			}
		}
	}
	...
	public void batchHyFormerCompanyProcess(List<HyFormerCompanyBean> hyFormerCompanyBeanList) {
		for (HyFormerCompanyBean hyFormerCompanyBean : hyFormerCompanyBeanList) {
			...
			case "inserted":
				hyFormerCompanyDAO.insertHyFormerCompany(hyFormerCompanyBean);
				break;
			case "updated":
				hyFormerCompanyDAO.updateHyFormerCompany(hyFormerCompanyBean);
				break;
			case "deleted":
				hyFormerCompanyDAO.deleteHyFormerCompany(hyFormerCompanyBean);
				break;
			}
		}
	}
	...
	public void batchHyYtaResultProcess(List<HyYtaResultBean> hyYtaResultBeanList) {
		for (HyYtaResultBean hyYtaResultBean : hyYtaResultBeanList) {
			...
			case "inserted":
				hyYtaResultDAO.insertHyYtaResult(hyYtaResultBean);
				break;
			case "updated":
				hyYtaResultDAO.updateHyYtaResult(hyYtaResultBean);
				break;
			case "deleted":
				hyYtaResultDAO.deleteHyYtaResult(hyYtaResultBean);
				break;
			}
		}
	}
