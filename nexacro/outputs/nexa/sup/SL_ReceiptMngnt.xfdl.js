(function()
{
    return function()
    {
        ...
        // User Script
        this.addIncludeScript("SL_ReceiptMngnt.xfdl", "scripts::commonTransaction.xjs");
        this.addIncludeScript("SL_ReceiptMngnt.xfdl", "scripts::commonScripts.xjs");
        this.addIncludeScript("SL_ReceiptMngnt.xfdl", "scripts::Scripts.xjs");
        this.registerScript("SL_ReceiptMngnt.xfdl", function() {
         /********************************************************************************
        *                                                                               *
        * 검체접수             												        	*
        *                                                                               *
        ...
        ********************************************************************************/
        ...
        this.loadIncludeScript("SL_ReceiptMngnt.xfdl");
