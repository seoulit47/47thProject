    ...
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            if (Form == this.constructor) {
                this.set_name("ABbudgExcutionViewForm");
                this.set_classname("AB_BudgExcutuinViewForm");
                this.set_titletext("예산집행현황조회");
            ...
            obj = new Static("titleEdt00", "absolute", "5.04%", "10", null, "44", "77.12%", null, this);
            obj.getSetter("taborder").set("2");
            obj.set_text("예산집행현황조회");
            obj.set_cssclass("TStc");
            obj.style.set_font("bold 15 Dotum");
            this.addChild(obj.name, obj);
            ...
            obj = new Button("searchBtn", "absolute", "495", "80", "90", "32", null, null, this);
            obj.set_taborder("8");
            ...
            obj = new Grid("budgGrid", "absolute", "1.28%", "139", null, "576", "1.04%", null, this);
            obj.set_taborder("9");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"219\"/><Column size=\"119\"/><Column size=\"202\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"80\"/><Column size=\"72\"/><Column size=\"58\"/><Column size=\"40\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell text=\"비목명\"/><Cell col=\"1\" text=\"비목코드\"/><Cell col=\"2\" text=\"계정명\"/><Cell col=\"3\" text=\"계획배정금액\"/><Cell col=\"4\" text=\"예산금액\"/><Cell col=\"5\" text=\"변경금액\"/><Cell col=\"6\" text=\"총원인금액\"/><Cell col=\"7\" text=\"예산잔액\"/><Cell col=\"8\" text=\"집행률\"/></Band><Band id=\"body\"><Cell displaytype=\"tree\" edittype=\"tree\" text=\"bind:bimokNm\" treestartlevel=\"1\" treelevel=\"bind:bimokLevel\"/><Cell col=\"1\" text=\"bind:bimokCd\"/><Cell col=\"2\" text=\"bind:acntNm\"/><Cell col=\"3\" text=\"bind:allotPlanAmount\"/><Cell col=\"4\" text=\"bind:budgAmount\"/><Cell col=\"5\" text=\"bind:cngAmount\"/><Cell col=\"6\" text=\"bind:causeAmount\"/><Cell col=\"7\" text=\"bind:budgBal\"/><Cell col=\"8\" text=\"bind:executionPercent\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj = new Layout("default", "", 1250, 768, this,
            	//-- Layout function
            	function(p) {
            		p.set_classname("AB_BudgExcutuinViewForm");
            		p.set_titletext("예산집행현황조회");
        ...
        // User Script
        this.addIncludeScript("AB_BudgExcutuinViewForm.xfdl", "scripts::commonScripts.xjs");
        this.registerScript("AB_BudgExcutuinViewForm.xfdl", function() {
        ...
        this.loadIncludeScript("AB_BudgExcutuinViewForm.xfdl");
