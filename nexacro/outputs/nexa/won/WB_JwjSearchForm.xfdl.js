(function()
{
    return function()
    {
        ...
        // User Script
        this.addIncludeScript("WB_JwjSearchForm.xfdl", "scripts::commonScripts.xjs");
        this.addIncludeScript("WB_JwjSearchForm.xfdl", "scripts::wonScripts.xjs");
        this.registerScript("WB_JwjSearchForm.xfdl", function() {
        /********************************************************************
        *                                                                   *
        * 원무 재원환자조회 관리                           				*
        *                                                                   *
        ...
        ********************************************************************/
        ...
        this.searchJwjBtn_onclick = function(obj,e){
        	...
        	if(patNo == null){
        		...
        		var row = this.dsService.findRow('serviceID' , "findJwjList");
        ...
        this.loadIncludeScript("WB_JwjSearchForm.xfdl");
